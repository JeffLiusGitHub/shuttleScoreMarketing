...
- [x] Adapted the generic Apple App marketing PRD to Sevix-specific positioning.
...
- [ ] Optional: register `https://sevix.app` and connect it in Netlify Domain management if using a custom branded domain.
- [ ] Inspect desktop/mobile layout visually in browser.
- [x] Replace placeholder App Store URL with the real App Store listing.
